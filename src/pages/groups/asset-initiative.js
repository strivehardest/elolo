...
import { Rocket, Users2, Lightbulb, Monitor, Award, CheckCircle, ArrowRight, Target, ArrowUp } from 'lucide-react';
import Link from 'next/link';

const ASSETInitiativePage = () => {
  const impacts = [
    { number: "1", label: "Flagship TVET LMS", text: "Develop one flagship TVET LMS/content ecosystem", icon: Rocket },
    { number: "200+", label: "Digital Learning Objects", text: "Produce 200+ digital TVET learning objects", icon: Lightbulb },
    { number: "50+", label: "Institutions Supported", text: "Support 50+ institutions across Ghana and West Africa", icon: Users2 },
    { number: "1st", label: "Technical Partner Status", text: "Become a recognized technical partner to government and donors", icon: Monitor }
  ];
  const scope = [
    "Development of digital learning platforms and tools",
    "Creation of CBT-aligned digital content for TVET LMSs",
    "Design of immersive learning solutions (VR/XR)",
    "Technical advisory on EdTech adoption",
    "Research and experimentation in learning technologies"
  ];
  const activities = [
    "TVET Digital Content Factory (CBT-aligned modules)",
    "Immersive Skills Labs (VR/XR pilots)",
    "Open TVET Digital Resource Repository",
    "EdTech Sandbox for TVET Institutions",
    "Digital Pedagogy & Systems Design Bootcamps"
  ];
  const approaches = [
    "Modular, reusable CBT digital objects",
    "Offline-first and low-bandwidth design",
    "Open standards and interoperability",
    "Co-creation with Mastercraft persons and facilitators"
  ];
  ...
  return (
    <>
      <SEOHead
        ...
        additionalMetaTags={[{
          name: 'keywords',
          content: 'ASSET Initiative, Elolo Agbleke, TVET, digital learning, Ghana, West Africa, technical education, partnerships, immersive learning, innovation'
        }]}
      />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="flex flex-col items-center text-center gap-6">
            ...
            <div className="w-32 h-32 md:w-40 md:h-40 bg-white rounded-2xl flex items-center justify-center shadow-2xl overflow-hidden p-4">
              <Image
                src="/groups/asset.png"
                alt="ASSET Initiative Logo"
                width={160}
                height={160}
        ...
        <div className="mb-24">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-[#65605b] leading-relaxed">
              To serve as Africa’s digital nucleus for TVET, developing tools, systems, and content that power modern skills training.
            </p>
          </div>
        ...
        <div className="mb-24 bg-gray-50 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg md:text-xl text-[#65605b] max-w-3xl mx-auto">
                Strategic initiatives designed to transform TVET systems across Africa
              </p>
            </div>
...
export default ASSETInitiativePage;
